...
In.add('config',{path:THEMEROOT+"crm/config/config.js",type:'js',charset:'utf-8',rely:['jquery']});
In.add('base',{path:THEMEROOT+"crm/config/base.js",type:'js',charset:'utf-8',rely:['config']});
