...
COMMONTEMP={
    ...
    /*信用认证图片上传*/
    T0030:'<div><img  class="lf ld" src="'+WEBROOT+'/zhixun/Theme/default/vocat/imgs/system/loading.gif" alt="名称"/><span class="lf lt">正在上传,请稍后</span></div>',
    /*清空选择中资质内容*/
...
SOURCENAME={
    ...
    /***** lib *****/
    L0001:THEMEROOT+"zmincrm/config/temple.js",
    ...
    /*******Controller******/
    c_CT0001:CRMURLROOT+"pages/resource_c_1.0.js",
    c_CT0002:CRMURLROOT+"pages/resourcedetail_c_1.0.js",
    /*********CRM_lib*************/
    c_L0001:THEMEROOT+"zminlib/mask/jquery.mask.js",
    c_M0002:THEMEROOT+"zminlib/edrecoder/edrecoder-hgs.js"
};
/****************************** 全局变量定义 ******************************/
/* 
 * 顶级命名空间HGS
...
//    }
    ...
    function LoadResourceResource(){
       ...
       In.add('p3',{path:sn.c_CT0001,type:'js',charset:'utf-8',rely:['p1']});
     ...
     */
      function LoadResourceDetail(){
       ...
       In.add('p8',{path:sn.c_M0002,type:'js',charset:'utf-8'});
       In.add('p1',{path:sn.c_M0001,type:'js',charset:'utf-8',rely:['p8']});    
       In.add('p3',{path:sn.c_CT0002,type:'js',charset:'utf-8',rely:['p1']});
