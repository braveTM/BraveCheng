	...
	jQuery(document).ready(
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
                            var str='<div id="ptTimeSelectCntr" class="">'
					+	'		<div class="ui-widget ui-widget-content ui-corner-all">'
					+	'		<div class="ui-widget-header ui-corner-all">'
					+	'			<div id="ptTimeSelectCloseCntr"><div class="seltime">选择时段</div>'
					...
					+	'					<div class="ptTimeSelectLeftPane" style="float: left;" class="">Hour</div>'
					+	'					<div class="ptTimeSelectRightPane" style="float: left;">Minutes</div>'
					+	'				</div>'
					+	'				<div>'
					+	'					<div class="hours">'
...
//					+	'							</div>'
					+	'							<div class="ptTimeSelectHrCntr">';
                                  ...
                                  for(var i=0;i<24;i++){
                                      if(i<=9)
                                      str1+='<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);">0'+i+'</a>';
                                      else
                                      str1+='<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);">'+i+'</a>';
                                  }
                                  for(var i=0;i<60;i++){
                                      if(i%5==0){
                                        if(i<=9)
                                            str2+='<a class="ptTimeSelectMin ui-state-default" href="javascript: void(0);">0'+i+'</a>';
                                        else
                                            str2+='<a class="ptTimeSelectMin ui-state-default" href="javascript: void(0);">'+i+'</a>';
                                        }
                                  }
                                  str+=str1;
                                  str+='								<br style="clear: left;" /><div></div>'
					+	'							</div>'
					+	'						</div>'
					+	'					</div>'
					+	'					<div class="mins">'
...
jQuery.ptTimeSelect.openCntr = function (ele) {
	...
	style.top			= ((style.top*1+5) + i.outerHeight());
