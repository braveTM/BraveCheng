 ...
 * 主题根目录
 */
THEMEROOT=FILEROOT+"/zhixun/Theme/default/";
/* 
 * vocat js文件的根目录
 */
JSURLROOT=THEMEROOT+"vocat/js/";
 /* 
 * 记录插件中访问系统图片的根路径
 */
/* 
 ...
 * crm js文件的根目录
 */
CRMURLROOT=THEMEROOT+"crm/js/";
In.add('jquery',{path:THEMEROOT+"lib/jquery-1.7.1.min.js",type:'js',charset:'utf-8'});
In.add('config',{path:THEMEROOT+"vocat/config/config.js",type:'js',charset:'utf-8',rely:['jquery']});
In.add('base',{path:THEMEROOT+"vocat/config/base.js",type:'js',charset:'utf-8',rely:['config']});
In.ready('jquery','config','base',function() {HGS.Base.LoadPageSource();});
//var _gaq = _gaq || [];
//_gaq.push(['_setAccount', 'UA-30838975-1']);
