...
<html>
    <head>
        ...
        <![endif]-->
        <script type="text/javascript" src="{$voc_root}/config/loader.js" id="loader">119</script>  
        <meta name='keywords' content='{$kwds}'>
        <meta name='description' content='{$desc}'>
    </head>
    <body>
        <!-- layout::{$bheader}::0 -->
        <div class="layout1 package apackage">
            <div class="layout1_l">
                <div class="module_1">
                    <!-- layout::{$z_left}::0 -->
                </div>
                        ...
                        <if condition="$has eq 0">
                            <div class="t_item mpack show">
                                ...
                                <div class="t_item mpack hidden">
                                    ...
                                    <if condition="$has eq 1 && $newc.free neq 1">
                                        <p class="title">您购买的<span class="red"> {$current.title} </span>您可更换/续费您的套餐 :</p>
                                        <elseif condition="$has eq 1 && $newc.free eq 1"/>
                                        <p class="title">您当前的套餐为<span class="red"> 免费版 </span> ，您可以更换您的套餐 :</p>                                        
                                    </if>
                                        <div class="scro rf"><em></em>我的积分 <span class="red">{$score}</span></div>
                                            ...
                                            <foreach name="list" item="l">
                                                ...
                                                <div class="mid_bg">
                                                    <div class="mid">
                                                        ...
                                                        <p class="score"><span>现价<em class="red">￥{$l.price}</em></span><span class="old_price">原价￥<php> echo $l->price*2 </php></span></p>
                                                        ...
                                                        <span class="tit_pac send">购买即送<em>{$l.price}</em>积分</span>
                                                    </div>                                                    
                                                </div>                                                
...
<!--                                                    <div class="oper oper_l">
                                                    ...
                                                    <div class="oper col1">
                                                        <a href="javascript:;" class="renew" pid="{$l.id}">续费购买</a>
                                                    </div>
                                                    <div class="oper col2">
                                                        <a href="javascript:;" class="rechange" pid="{$l.id}">积分续费</a>
                                                    </div>  
                                                    <else/>
                                                    <div class="oper col1">
                                                    ...
                                                    <div class="oper col2">
                                                        <a href="javascript:;" class="change" pid="{$l.id}">积分兑换</a>
                                                    </div>                                                    
                                                </if>
                                                </li>
                                            </foreach>
                                            <li>
                                                ...
                                                <div class="mid_bg">
                                                    <div class="mid">
                                                        ...
                                                        <p class="score"><span><em class="red">￥0</em></span></p>
                                    ...
                                    <div class="intro">
                                        <p>套餐说明：</p>
                                        <p>· 若续费/兑换已购买套餐, 之前套餐剩余次数将自动累加到新套餐中。</p>
                                        <p>· 若购买/更换不同套餐, 之前套餐剩余次数将自动清零。</p>
                                        <p>· 购买套餐可获得等价积分。如: 购买“专业版”套餐花费金额 ￥4400, 您可获赠 4400个积分。</p>
                                        <p>· 积分兑换套餐, 将扣除对等积分。如: 积分兑换“专业版”套餐, 花费 4400个积分, 将从您的总积分中扣除 4400个积分。</p>
                                    </div>
                                </div>
                            </div>
                    </div>
