...
<html>
    ...
    <body>
            ...
            <div class="pub_mid">
                ...
                <div class="p_m_mid">
                    <div class="p_m_mid_bg">
                        <div class="lay1_l lf">
                            <!-- layout::Public:lnav::0 -->
                        </div>
                        <div class="lay1_r rf">
                            <div class="lr_ct">
                                <h2 class="sort">
                                    <span class="ft">{$article.title}</span>
                                    <span>{$article.en}</span>
                                </h2>
                                <div class="adetail">
                                    {$article.content}
                                </div>
        ...
        <script type="text/javascript">
            var knml=document.getElementById("knml11");
            knml.className="cur_p";
        </script>
    </body>
</html>