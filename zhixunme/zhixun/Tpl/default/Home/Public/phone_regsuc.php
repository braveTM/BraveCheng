            ...
            <div class="pub_mid">
                ...
                <div class="p_m_mid">
                    <div class="p_m_mid_bg">
                        <div class="t_wrap">
                            <div class="t_eip">
                                <p class="blue">手机验证已成功,开始职讯之旅！</p>
                                <p class="t_p">您的登录帐号为: <span class="blue">{$phone}</span>, 已通过系统认证</p>
                                <p class="t_p"><span id="timer" class="red">10</span>秒之后将带您进入您的<a href="{$web_root}/rhome/" title="个人中心" class="blue">个人中心</a>,开始您的职讯之旅吧!</p>
                                <div class="below_tip">
                                    <div class="sm_tip lf">
                                    </div>
