...
<html>
    <head>
        ...
        <![endif]-->
        <script type="text/javascript" src="{$voc_root}/config/loader.js" id="loader">46</script>  
            ...
            <div class="pub_top">
                <div class="p_t_txt">
                    <a href="{$web_root}" title="职讯网首页">
                     ...
                     <a href="{$web_root}/aregister/" title="猎头注册" class="white role">猎头注册<em class="cur_role"></em></a>
                     <a class="white">|</a>
...
<!--                                    <tr>
                                        ...
                                        <td>
                                            <textarea id="u_detail" class="gray">个人简介是您对外形象展示的重要窗口，您可以就从业年限、行业经验、服务过的大客户、所在经济公司的实力等能提升个人专业度和价值的方面进行自我介绍。</textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div><input type="text" value="" id="u_bagent" /></div>
                                        </td>
                                    </tr>-->
                                    <tr>
                                        <td class="t_l">
                                ...
                                <div class="p3">
                                    <div class="u_n btn5 btn_common ">
                                        ...
                                        <a  class="btn white" id="ag_nex" href="javascript:;">下一步</a>
                                    </div>
                                </div>
                            </div>
                        </div>
