...
<div class="bheader" id="bheader">
    <div class="bh_cont">
        <a class="logo lf title" id="logo_a" href="{$web_root}/{$user_id_self}/index/" title="回到首页">
            <img src="{$voc_root}/imgs/system/logo.png">
        </a>
        </script>
        <span class="mliner" id="mliner"></span>
        <input type="hidden" id="utp" value="2"/>
        <div class="lf bh_nav">
            <a href="{$web_root}/{$user_id_self}/index/">个人中心</a>
            <a href="{$web_root}/atm/">简历管理</a>
            <a href="{$web_root}/apm/">职位管理</a>
            <a href="{$web_root}/resource/">客户管理</a>
                ...
                <div class="children">
                    ...
                    <div class="mid">
                        <div class="mid_bg">
                            ...
                            <div class="lf">
                                <p class="name"><span class="name">{$info.name}</span><span class="gray"> - 猎头</span></p>
                                <a href="{$web_root}/profiles/" class="blue">帐号资料</a>
                            </div>
                            <p class="clr"></p>
                            <p class="uhomea">
                                <a href="{$web_root}/bill/" class="blue">我的账户</a><span class="blue"> | </span><a href="{$web_root}/mpackage/" class="blue">我的套餐</a><span class="blue"> | </span><a href="{$web_root}/apromotion/" class="blue">我要推广</a>
                            </p>
                        </div>
                    </div>
                    <p class="bot"></p>
