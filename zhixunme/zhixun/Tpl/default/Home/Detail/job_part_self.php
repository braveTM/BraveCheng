...
<html>
    <head>
        ...
        <![endif]-->
        <script type="text/javascript" src="{$voc_root}/config/loader.js" id="loader">49</script>
            ...
            <div class="layout_mid dborder">
                <div class="ly_m_l">
                    <div class="module_1 detinfo">
                        ...
                        <p class="blue">
                            <span class="red" jid="{$job.id}" id="fullid">[兼职] </span> {$job.title} 
                            <span class="gray">(发布于 {$job.date})</span>
                            <span class="red rf count">{$job.read_count}</span><span class="gray rf">浏览数:</span>
                        </p>                       
                        ...
                        <div class="item thritem">
                            <p class="gray">地区要求 :</p>
                            <p class="detail sdet">{$job.place}</p>
                            <p class="gray _tr">证书使用地 :</p>
                        ...
                        <div class="hd_item hidden" id="hd_item">
                            <div class="item thritem">
                                ...
                                <p class="gray _tr">工作状态 :</p>
                                <p class="detail sdet">{$job.state}</p>
                                <p class="gray">学历要求 :</p>
                            ...
                            <div class="item thritem">
                                ...
                                <p class="gray _tr">考取安全B证 :</p>
                                <p class="detail sdet">{$job.bcard}</p>
                                <p class="gray">社保要求 :</p>
                                <p class="detail sdet">{$job.social}</p>
                                <div class="clr"></div>
                            </div>
                            <div class="item">
                                <p class="gray">职位描述 :</p>
                                <notempty name="job.descript">
                                    <p class="detail _desc">{$job.descript}</p>
                                </notempty>                                
                                <empty name="job.descript">
                                    <p class="detail red">暂无</p>
                                </empty>                                                                
                                <div class="clr"></div>
                            </div>
                        ...
                        <div class="chmore" id="chmore">
                             <div class="shares"  id="share">
                                    <span class="lf gray">分享职位：</span>
                                     <a class="share shr_1" href="javascript:;" tp="sina" title="分享到新浪微博" ur="{$web_root}/office{$isblog}/{$job.id}" tit="[兼职]{$job.title}"></a>
                                    <a class="share shr_2" href="javascript:;" tp="tencent" title="分享到腾讯微博" ur="{$web_root}/office{$isblog}/{$job.id}"  tit="[兼职]{$job.title}"></a>
                                    <a class="share shr_3" href="javascript:;" tp="qzone" title="分享到QQ空间" ur="{$web_root}/office{$isblog}/{$job.id}"   tit="[兼职]{$job.title}"></a>                                                                                                                                      
                                    <p class="clr"></p>
                             </div> 
