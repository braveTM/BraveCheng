...
<html>
    <head>
        ...
        <![endif]-->
        <script type="text/javascript" src="{$voc_root}/config/loader.js" id="loader">109</script>
    ...
    <body>
        ...
        <div></div>
        <div class="layout2 comdetail homedetail agdetail agd unlogin">
            <div class="layout2_l">
            <div class="layout_mid">
                <div class="ly_m_l">
                    <div class="module_1">
                        ...
                        <div class="aginfo">                            
                            <div class="identify">
                                <span class="blue _name" id="name" title="{$agent.name}">{$agent.name}</span>
                                ...
                                <div class="shares" id="share" uname="{$agent.name}">
                                    <div id="ckepop">
                        ...
                        <div class="baseinfo lf">
                            ...
                            <p class="conts sys_note">登录后免费查看猎头联系方式</p>                                                            
                            <p class="baseinfo_t">
                                <span class="gray">地区 :</span>&nbsp;&nbsp;
                                <span>{$agent.location}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<!--                                <span class="gray">从业经验 :</span>&nbsp;&nbsp;
...
<!--                        <if condition="$iscontact eq 1">
                            <div class="conts lf" id="cont_way">
                                <else/><div class="conts hidden lf" id="cont_way">
                                    </if>
                                    ...
                                    <p><span class="gray">QQ:</span><span class="ph_qq">{$contacts.qq}</span></p>
                                </div>-->                        
                        <p class="clr"></p>                            
                            <div class="action rf">
                    ...
                    <div class="ops_filter module_2" id="talfilter" uid="{$agent.user_id}"> 
                        <div class="sm_tab">
                            <ul class="filt_type">                                                              
                                    ...
                                    <li class="cur_li"><a href="javascript:;" class="blue" tp="1">正在运作的职位</a></li>                                                   
                            </ul>
                        </div>
                                    ...
                                    <foreach name="resume" item="vo" >
                                        ...
                                        <if condition="$vo.job_category eq 2">
                                            <div class="lf info">
                                                ...
                                                <php>$last = count($vo->RC_list) - 1;</php>
            ...
            <div class="layout2_r">
                <div class="lmain promlst">
                    ...
                    <if condition="empty($service_company_list)">
                        ...
                        <a href="{$web_root}/{$com.user_id}" title="{$com.name}" class="undline" target="_blank">{$com.name}</a>                        
                        </foreach>                    
                        <div class="border"></div>
                    </if>                                                                                
                     ...
                     <foreach name="latest_blog" item="blog">
                        <a href="{$web_root}/article/1/{$blog.blog_id}" title="{$blog.title}" class="undline"  target="_blank">{$blog.title}</a>
                     </foreach>
