...
<html>
    <head>
        ...
        <![endif]-->
        <script type="text/javascript" src="{$voc_root}/config/loader.js" id="loader">51</script>
                ...
                <div class="ly_m_l">
                    <div class="module_1 c">
                        ...
                        <div class="aginfo">
                            <div class="myfollow rf">
                                ...
                                <switch name="company.follow">
                                    ...
                                    <case value="1">
                                        ...
                                        <div class="re_focus"><span class="gray"  href="javascript:;">已关注 </span><a id="re_focus" uid="{$company.user_id}" uname="{$company.name}" class="mdetail btn blue">取消</a></div>                                        
                                        </div>                                         
                                    </case>
                                </switch>
                                </if>
                            ...
                            <div class="identify">
                                <span class="blue _cname" title="{$company.name}">{$company.name}</span>
