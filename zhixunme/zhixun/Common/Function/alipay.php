<?php
require_cache('zhixun/Common/Plugins/Payments/PayAlipay/lib/alipay_service.class.php');
require_cache('zhixun/Common/Plugins/Payments/PayAlipay/lib/alipay_notify.class.php');
/**
 * 支付宝支付
 */
function alipayto($order_id){
    $aliapy_config = C('ALIPAY_CONFIG');
