...
class LabelService{
    ...
    public function get_children($id, $role_id = null, $first_letter = null){
        $data = $this->provider->get_children($id, $role_id, $first_letter);
        return $data;
    }
    ...
    public function group_first_letter($id, $role_id = null){
        $data = $this->provider->group_first_letter($id, $role_id);
        return $data;
    }
    ...
    public function get_user_labels($user_id){
        $data = $this->provider->get_user_labels($user_id);
        return $data;
    }
    ...
    public function get_label($id){
        $data = $this->provider->get_label($id);
        return $data;
    }
