...
class SlideDomain{
    ...
    public function add_slide($location_id, $location_name, $image, $alt){
        return $this->provider->add_slide($this->filter_location_id($location_id), $this->filter_location_name($location_name), $this->filter_image($image), $this->filter_alt($alt));
    }
    ...
    public function delete_slide($id){
        return $this->provider->delete_slide($id);
    }
    ...
    public function update_slide($id, $image, $alt){
        return $this->provider->update_slide($id, $this->filter_image($image), $this->filter_alt($alt));
    }
