 ...
 * @access  chenghuiyong  2012-09-26 17:11 chenghuiyong1987@gmail.com
 */
class Template {
        ...
        function display($filename, $cache_id = '') {
                ...
                $out = str_replace("<meta name=\"Generator\" content=\"ECSHOP v2.7.3\" />\r\n", '', $out);
                echo $out;
        }
                ...
                if (empty($tag)) {
                        ...
                        switch ($tag_sel) {
                                ...
                                case 'html_checkboxes':
                                        ...
                                        return '<?php echo $this->html_checkboxes(' . $this->make_array($t) . '); ?>';
                                        break;
